...
function rollupPluginCommit() {
  const target = '../static-assets/plugins/org/pn/plugin/bulkedit/sidebar/bulkedit/index.js';
...
export default {
  ...
  plugins: [
    ...
    commonjs(),
    copy({
      targets: [{ src: 'dist/*', dest: '../static-assets/plugins/org/pn/plugin/bulkedit/sidebar/bulkedit/' }],
      hook: 'writeBundle'
    }),
    rollupPluginCommit()
  ]
